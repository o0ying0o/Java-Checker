/* Class: InputData
 * Original Author: Stan Pieda
 * Modified by: Dave Houtman
 * Modified as of: June 30, 2024
*/
...
public class InputData {
	...
	/* This method prompts the user with the message String parameter
	 * and then calls validateInt() to get the actual input value.
	*/
	...
	/* This method loops until an int value is entered.  Each time the incorrect
	 * data type is entered, the method outputs the INT_MESSAGE, asking
	 * the user to re-enter the correct data type.
	*/
	...
	/* This method prompts the user with the message String parameter
	 * and then calls validateDouble() to get the actual input value.
	*/
	 ...
	 * data type is entered, the method outputs the DOUBLE_MESSAGE, asking
	 * the user to re-enter the correct data type.
	*/
	...
	/* This method prompts the user using the message parameter provided, 
	 * then inputs the String entered by the userString.  Since everything 
	 * entered can be treated as a String type, there is no way to actually
	 * validate String input.  This method is provided for completeness only.
	*/
